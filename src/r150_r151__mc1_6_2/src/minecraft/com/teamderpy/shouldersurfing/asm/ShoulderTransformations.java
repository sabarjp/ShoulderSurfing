...
public class ShoulderTransformations implements IClassTransformer
{
    ...
    public ShoulderTransformations()
    {
        ...
        registerMapping("EntityRendererClass",     "net.minecraft.client.renderer.EntityRenderer", "bfb");
        registerMapping("EntityRendererJavaClass", "net/minecraft/client/renderer/EntityRenderer", "bfb");
        registerMapping("EntityLivingJavaClass",   "net/minecraft/entity/EntityLivingBase"       , "oe");
        registerMapping("EntityJavaClass",         "net/minecraft/entity/Entity"                 , "nm");
        ...
        registerMapping("clippingHelperImplJavaClass",     "net/minecraft/client/renderer/culling/ClippingHelperImpl", "bfr");
        registerMapping("clippingHelperJavaClass",         "net/minecraft/client/renderer/culling/ClippingHelper"    , "bft");
         ...
         */
        registerMapping("GuiIngameClass",              "net.minecraft.client.gui.GuiIngame", "avg");
        registerMapping("GuiIngameJavaClass",          "net/minecraft/client/gui/GuiIngame", "avg");
        registerMapping("GuiJavaClass",                "net/minecraft/client/gui/Gui"      , "avh");
         ...
         */
        registerMapping("RenderPlayerClass",           "net.minecraft.client.renderer.entity.RenderPlayer", "bhg");
        registerMapping("RenderPlayerJavaClass",       "net/minecraft/client/renderer/entity/RenderPlayer", "bhg");
        registerMapping("renderPlayerMethod",          "renderPlayer"                                     , "a");
        registerMapping("EntityPlayerJavaClass",       "net/minecraft/entity/player/EntityPlayer"         , "ue");
    }
