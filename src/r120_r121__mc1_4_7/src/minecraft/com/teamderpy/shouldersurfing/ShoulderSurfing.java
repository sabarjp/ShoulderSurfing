...
public class ShoulderSurfing extends DummyModContainer{	
    ...
    public static void writeConfig(){
    	config.get(Configuration.CATEGORY_GENERAL, "rotationOffset", ShoulderCamera.SHOULDER_ROTATION, "Third person camera rotation").value = Float.toString(ShoulderCamera.SHOULDER_ROTATION);
    	config.get(Configuration.CATEGORY_GENERAL, "zoomOffset"    , ShoulderCamera.SHOULDER_ZOOM_MOD, "Third person camera zoom").value = Float.toString(ShoulderCamera.SHOULDER_ZOOM_MOD);
